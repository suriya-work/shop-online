...
function Cartpage() {
    ...
    return (
        <div className="cart-Page">
            ...
            <div className="">
                <div className="container md:mx-auto md:ml-8 pl-2 pr-2 grid grid-cols-1  md:grid-cols-1 lg:grid-cols-1 gap-5 mt-[10px]">
                            ...
                            return (
                                <div className="border p-5 flex flex-col md:flex-row rounded-[8px] justify-between items-center w-[100%] md:w-[73%] lg:w-[70%]">
                                    ...
                                    <div className="w-[50%]">
                                        ...
                                        <p className="font-bold text-[16px] text-myRed mt-4">
                                            ${item.price}
                                        </p>
                                    </div>
                                    <div className="flex gap-8 md:ml-auto items-center ">
                                        ...
                                        <div className="flex gap-3">
                                            <button
                                                className="border px-3 py-1 font-bold rounded-[8px] cursor-pointer"
                                                onClick={() => dispatch(incrementQuantity(item.id))}
                                            >
                                                +
                                            </button>
                                            <div className="bg-[#eee]  border rounded-full font-bold px-3 py-1">
                                                <p className="pt-1">
                                                    {item.quantity}
                                                </p>
                                            </div>
                    ...
                    {myData.length !== 0 ? (
                        // <div className="">
                        <div className="w-[70%] h-[300px] md:w-[25%] rounded-[8px] m-auto md:h-[293px] flex flex-col  items-center justify-evenly md:fixed md:right-0 md:mr-1 lg:mr-24  border">
