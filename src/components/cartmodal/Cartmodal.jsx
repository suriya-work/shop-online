...
const Cartmodal = ({ cart, shown, close }) => {
  ...
  return shown ? (
    <div className="modal-backdrop" onClick={close}>
      <div
        className="bg-white md:top-[7%] md:w-[95%] lg:w-[40%] w-[95%] top-[8%] h-[500px]  shadow-2xl border  fixed z-30 right-[0px] lg:top-[12.5%] overflow-y-scroll scrollbar-hide"
        onClick={(e) => e.stopPropagation()}
      >
        {cart.length === 0 ? (
          <div className="h-full flex justify-center items-center text-center  text-2xl">
            <h2 className="text-center m-auto text-black">
              Your Cart Is Empty!
            </h2>
          </div>
        ) : (
